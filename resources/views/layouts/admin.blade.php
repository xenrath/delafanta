      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/sub-kategori') }}"
                class="nav-link {{ request()->is('admin/sub-kategori*') ? 'active' : '' }}">
                <i class="nav-icon fas fa-ticket-alt"></i>
                <p>
                  Data Sub Kategori
                </p>
            ...
            <li class="nav-item">
              <a href="{{ url('admin/warna') }}" class="nav-link {{ request()->is('admin/warna*') ? 'active' : '' }}">
                <i class="nav-icon fas fa-sort-amount-down"></i>
                <p>
                  Data Warna
                </p>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Yakin keluar sistem <strong>AdminDelafan</strong>?</p>
          </div>
