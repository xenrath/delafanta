...
@section('title', 'Ubah Sub Kategori')
          ...
          <div class="card-body">
              ...
              <select class="custom-select form-control" id="kategori_id" name="kategori_id">
                ...
                @foreach ($kategoris as $kategori)
                  <option value="{{ $kategori->id }}"
                    {{ old('kategori_id', $sub_kategori->kategori_id) == $kategori->id ? 'selected' : '' }}>
            ...
            <div class="form-group">
              ...
              <select class="custom-select form-control" id="jenis" name="jenis">
                <option value="">- Pilih -</option>
                <option value="1" {{ old('jenis', $sub_kategori->jenis) == '1' ? 'selected' : '' }}>Berdasarkan tingkat</option>
                <option value="0" {{ old('jenis', $sub_kategori->jenis) == '0' ? 'selected' : '' }}>Tidak berdasarkan tingkat</option>
              </select>
            </div>
          </div>
